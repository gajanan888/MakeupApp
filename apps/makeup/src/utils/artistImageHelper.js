...
const portfolioGalleryPool = [
  {
    tag: 'Bridal Royal Transformation',
    description: 'High definition airbrush bridal makeup with traditional gold shimmer accents.',
  ...
  {
    tag: 'Editorial High-Fashion Look',
    description: 'Avant-garde editorial makeup created for magazine cover shoot.',
  ...
  {
    tag: 'South Indian Temple Bridal',
    description: 'Traditional silk saree draping with temple jewelry and jasmine flower hairdo.',
  ...
  {
    tag: 'Dewy Glass Skin Glow',
    description: 'Minimalist nude glam with glowing glass skin and soft nude lips.',
    before: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&auto=format&fit=crop&q=80',
    after: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=600&auto=format&fit=crop&q=80',
    extra: [
  ...
  {
    tag: 'Nizami Royal Glam',
    description: 'Glitter cut-crease eye art with airbrush porcelain base.',
    before: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&auto=format&fit=crop&q=80',
  ...
  {
    tag: 'Bengali Bridal Chandan',
    description: 'Intricate Chandan art with bold kohl eyes and red bindi.',
    before: 'https://images.unsplash.com/photo-1521119989659-a83eee488004?w=600&auto=format&fit=crop&q=80',
    after: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&auto=format&fit=crop&q=80',
    extra: [
      'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&auto=format&fit=crop&q=80'
    ]
  },
  {
    tag: 'Sun-Kissed Beach Bridal',
    description: 'Waterproof bronze glow suitable for outdoor sunset ceremonies.',
    before: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=600&auto=format&fit=crop&q=80',
    after: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=600&auto=format&fit=crop&q=80',
    extra: [
      'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=600&auto=format&fit=crop&q=80'
    ]
  ...
  {
    tag: 'Cocktail Party Glam',
    description: 'Smokey eye makeover with metallic pigments and bold matte lipstick.',
    before: 'https://images.unsplash.com/photo-1542103749-8ef59b94f47e?w=600&auto=format&fit=crop&q=80',
