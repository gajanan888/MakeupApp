// ClientOTPVerificationScreen.js
...
import { registerClient, sendOtp, verifyOtp } from '../../api/auth';

const OTP_LENGTH = 6;
const RESEND_SECONDS = 30;

const ClientOTPVerificationScreen = ({ navigation, route }) => {
...
export default ClientOTPVerificationScreen;
